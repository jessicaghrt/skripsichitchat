...
public class DTNHost implements Comparable<DTNHost> {
    ...
    //tambahan
    private List<String> socialProfile;
    ...
    public DTNHost(List<MessageListener> msgLs,
        ...
        this.socialProfile = new ArrayList<String>(socialProfile);
    ...
    public List<String> getSocialProfile() {
        return socialProfile;
    }

    public void setSocialProfile(List<String> socialProfile) {
