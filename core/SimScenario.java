...
public class SimScenario implements Serializable {
    ...
    protected SimScenario() {
        ...
        this.interests.add("Sport");
        this.interests.add("Cooking");
        this.interests.add("Film");
        this.interests.add("Traveling");
        this.interests.add("Music");
    ...
    protected void createHosts() {
        ...
        for (int i = 1; i <= nrofGroups; i++) {
            ...
            for (int j = 0; j < nrofHosts; j++) {
                ...
                // put social profile in a node
                List<String> socialProfile = new ArrayList<String>();
                Collections.shuffle(this.interests);
                int random = (int) (1 + (Math.random() * this.interests.size()));
                for (int h = 0; h < random; h++) {
                    socialProfile.add(this.interests.get(h));
//                                    System.out.print(this.interests.get(h)+" ");
                }
//                                System.out.println("");
                ...
                DTNHost host = new DTNHost(this.messageListeners,
                        ...
                        mmProto, mRouterProto, socialProfile);
                hosts.add(host);
            }
