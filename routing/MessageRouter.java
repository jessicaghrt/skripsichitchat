...
public abstract class MessageRouter {
     ...
     * <LI/> 3 : PRIORITIZED_INTEREST (most the highest priority value is sent
     * first)
     * </UL>
     */
    ...
    /**
     * Setting value for Priority and Interest queue mode
     */
    // tambahan
    public static final int Q_MODE_PRIORITIZED = 3;
    /**
     * Setting value for TTL queue mode
     */
//    public static final int Q_MODE_TTL = 4;   
    /**
...
//            sendQueueMode = Q_MODE_PRIORITIZED;
//            sendQueueMode = Q_MODE_RANDOM;
//            sendQueueMode = Q_MODE_TTL;
            sendQueueMode = Q_MODE_FIFO;
        }
    ...
    protected List sortByQueueMode(List list) {
        switch (sendQueueMode) {
            ...
            // tambahan
            case Q_MODE_PRIORITIZED:
                Collections.sort(list,
                        new Comparator() {
                    /**
                     * Compares two tuples by their messages prioritized value
                     */
                    public int compare(Object o1, Object o2) {
                        double diff;
                        Message m1, m2;
                        ...
                        // tambahan                        
                        diff = (int) m1.getProperty("Priority") - (int) m2.getProperty("Priority");
...
//                break;
    ...
    protected int compareByQueueMode(Message m1, Message m2) {
        switch (sendQueueMode) {
            ...
            /* add more queue modes here */
//            case Q_MODE_TTL:
//                double diff_TTL = m1.getTtl() - m2.getTtl();
//                if (diff_TTL == 0) {
//                    return 0;
//                }
//                return (diff_TTL < 0 ? -1 : 1);
            default:
                throw new SimError("Unknown queue mode " + sendQueueMode);
        }
    }
