...
public class BubbleRapEdit implements RoutingDecisionEngine, CommunityDetectionEngine, ConnectionHistoryEngine {
    ...
    public BubbleRapEdit(Settings s) {
    ...
    public BubbleRapEdit(BubbleRapEdit proto) {
    ...
    public void doExchangeForNewConnection(Connection con, DTNHost peer) {
        ...
        BubbleRapEdit de = this.getOtherDecisionEngine(peer);
...
//        double time = startTimestamps.get(peer);
    ...
    public boolean shouldSendMessageToHost(Message m, DTNHost otherHost, DTNHost thisHost) {
        ...
        BubbleRapEdit de = getOtherDecisionEngine(otherHost);
    ...
    public boolean shouldDeleteSentMessage(Message m, DTNHost otherHost) {
        ...
        BubbleRapEdit de = this.getOtherDecisionEngine(otherHost);
    ...
    public boolean shouldDeleteOldMessage(Message m, DTNHost hostReportingOld) {
        //BubbleRapEdit de = this.getOtherDecisionEngine(hostReportingOld);
        //return de.commumesWithHost(m.getTo()) &&
        //		!this.commumesWithHost(m.getTo());
    ...
    private BubbleRapEdit getOtherDecisionEngine(DTNHost h) {
        MessageRouter otherRouter = h.getRouter();
        assert otherRouter instanceof DecisionEngineRouter : "This router only works "
                + " with other routers of same type";

        return (BubbleRapEdit) ((DecisionEngineRouter) otherRouter).getDecisionEngine();
    }
